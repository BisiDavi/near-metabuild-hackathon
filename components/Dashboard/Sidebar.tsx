...
export default function Sidebar() {
  ...
  return (
    <aside className="relative w-2/12 bg-gray-200 px-4">
      <ul>
        {sidebarMenu.map((item) => {
          ...
          return (
            <li
              key={item.title}
              className={`${activeRoute} my-5 w-full border-b border-white  hover:border-blue-500 hover:text-blue-500`}
            >
        ...
        {authStatus === 'success' && authData !== null && (
          <div className="icon bg-skyblue absolute bottom-24 left-16 mx-auto flex h-14 w-14 items-center justify-center rounded-full text-2xl font-bold text-white">
